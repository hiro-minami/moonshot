...
type ObjectiveDeleteAlertModalProps = {
  onClick: () => void;
};
export const ObjectiveDeleteAlertModal = ({
  onClick,
}: ObjectiveDeleteAlertModalProps) => {
  return (
    <AlertDialog.Root>
      ...
      <AlertDialog.Content style={{ maxWidth: 450 }}>
        <AlertDialog.Title>Objectiveを削除する</AlertDialog.Title>
        <AlertDialog.Description size="3">
          <p>本当に削除しますか？削除した場合、復元することはできません。</p>
          <p>また、削除した期間に紐づくKeyResultとタスクも削除されます。</p>
